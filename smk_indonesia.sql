...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Des 2019 pada 04.37
...
INSERT INTO `guru` (`id_guru`, `nip`, `nama_guru`, `gelar`, `alamat`, `kelas`, `mapel`) VALUES
(27, 123456788, 'Yeni Elvira', 'M.Pd.', 'Bogor', '4,12', 'Bahasa Indonesia'),
(28, 123456789, 'Bambang', 'S.Ds.', 'Mana yya', '11', 'Matematika');
...
INSERT INTO `nilai` (`id_nilai`, `id_mapel`, `id_siswa`, `nip`, `uh`, `uts`, `uas`) VALUES
(4, 3, 35, 123456789, 87, 90, 98),
(11, 3, 34, 123456788, 89, 87, 67),
(21, 6, 34, 123456789, 90, 90, 90);
...
(9, 'TP', 'Teknik Mesin'),
(11, 'TKR', 'Teknik Kendaraan Ringan');
...
(34, 1017007668, 'Adinda Lailatul', 'Perempuan', 'Sanja', 11, 4),
(35, 1017007670, 'Aisyah Adillah', 'Perempuan', 'Rajeg\r\n', 9, 3);
...
(5, 1001, 'admin', 'admin', ''),
(10, 123456788, 'jugasayangayah', 'guru', 'guru10.jpg'),
(14, 123456789, 'duadua', 'guru', 'guru8.jpg'),
(15, 1017007670, 'isah123', 'siswa', '_DSC0565.JPG'),
(17, 3534643262634, 'akusayangibu', 'guru', 'guru4.jpg'),
(18, 65434567889456, 'satusatu', 'guru', 'guru3.jpg');
