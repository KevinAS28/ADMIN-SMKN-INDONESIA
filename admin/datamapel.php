...
<body class="ignielPelangi">
	...
	<div class="container"><br>
		<b>Data Mapel&nbsp;<i class="fa fa-chevron-right"></i></b>
		<hr>
		<div class="main-wrapper">
			<div class="main">
				<article>
					<table class="table table-secondary table-hover table-striped tableMapel">
						...
						<tbody>
							<?php
							$sql = mysqli_query($mysqli, "SELECT * FROM mapel  ORDER BY id_mapel DESC");
						...
						?>
							<tr>
								...
								<td>
									<a href="editmapel.php?id_mapel=<?php echo $data['id_mapel'] ?>"
										class="btn btn-warning">Update</a>
									<a href="deletemapel.php?id_mapel=<?php echo $data['id_mapel'] ?>"
				...
				<aside>
					<a href="tambahmapel.php" class="btn btn-dark">Tambah<br> Data Mapel</a>
