...
<body class="ignielPelangi">
	...
	<div class="container"><br>
		<b>Data Admin&nbsp;<i class="fa fa-chevron-right"></i></b>
		<hr>
		<div class="main-wrapper">
			<div class="main">
				<article>
				<table class="table table-secondary table-hover table-striped tableAdmin">
						...
						<tbody>
						<?php
							$sql = mysqli_query($mysqli, "SELECT * FROM `user` WHERE level='admin' ORDER BY id_user DESC");
						...
						?>
							<tr>
								...
								<td>
									<a href="editadmin.php?id_user=<?php echo $data['id_user'] ?>"
										class="btn btn-warning">Update</a>
									<a href="deleteadmin.php?id_user=<?php echo $data['id_user'] ?>"
				...
				<aside>
					<a href="tambahadmin.php" class="btn btn-dark">Tambah<br> Admin</a>
