			...
			<div class="main">
				<article>
					<table class="table table-secondary table-hover table-striped tableSiswa">
						...
						<tbody>
							<?php
							$sql = mysqli_query($mysqli, "SELECT * FROM `siswa` INNER JOIN prodi ON siswa.id_prodi = prodi.id_prodi INNER JOIN user ON siswa.nis = user.username  INNER JOIN kelas ON siswa.id_kelas = kelas.id_kelas ORDER BY id_siswa DESC");
						...
						?>
							<tr>
								...
								<td>
									<a href="editsiswa.php?id_siswa=<?php echo $data['id_siswa'] ?>"
										class="btn btn-warning">Update</a>
									<a href="deletesiswa.php?id=<?php echo $data['id_siswa'] ?>"
				...
				<aside>
					<a href="tambahsiswa.php" class="btn btn-dark">Tambah<br> Data Siswa</a>
