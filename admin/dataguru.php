...
<body class="ignielPelangi">
	...
	<div class="container"><br>
		...
		<div class="main-wrapper">
			<div class="main">
				<article>
					<table class="table table-secondary table-hover table-striped tableGuru">
						...
						<tbody>
							<?php
								...
								// var_dump
								// $sql2 = mysqli_query($mysqli,"SELECT * FROM kelas INNER JOIN prodi ON prodi.id_prodi = kelas.id_prodi WHERE id_kelas IN ()")
							...
							<tr>
								...
								<td>
									<a href="editguru.php?id_guru=<?php echo $data['id_guru'] ?>"
										class="btn btn-warning">Update</a>
									<a href="deleteguru.php?id_guru=<?php echo $data['id_guru'] ?>"
				...
				<aside>
					<a href="tambahguru.php" class="btn btn-dark">Tambah<br> Data Guru</a>
