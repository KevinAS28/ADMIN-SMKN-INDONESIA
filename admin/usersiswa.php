...
<body class="ignielPelangi">
			...
			<ul class="nav navbar-nav ">
				...
				<li class="nav-item dropdown  active">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						...
						<a class="dropdown-item  active" href="../admin/usersiswa.php">Siswa</a>
					</div>
				</li>
				<li class="nav-item">
					<a href="#" class="nav-link">|</a>
	...
	<div class="container"><br>
		<b>Data User Siswa&nbsp;<i class="fa fa-chevron-right"></i></b>
		<hr>
		<div class="main-wrapper">
			<div class="main">
				<article>
				<table class="table table-secondary table-hover table-striped tableUserSiswa">
						...
						?>
							<tr>
								...
								<td>
									<a href="editusersiswa.php?id_user=<?php echo $data['id_user'] ?>"
										class="btn btn-warning">Update</a>
									<a href="deleteusersiswa.php?id_user=<?php echo $data['id_user'] ?>"
				...
				<aside>
					<a href="tambahusersiswa.php" class="btn btn-dark">Tambah<br> User Siswa</a>
