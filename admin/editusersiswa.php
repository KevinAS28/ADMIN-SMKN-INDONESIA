...
if($_SESSION['status']!="login"){
    ...
    if(isset($_GET['id_user'])){
		...
		if(mysqli_num_rows($select) == 00 AND in_array($ekstensi, $ekstensi_foto) === true){
...
<?php
    if(isset($_POST['submit'])){
		...
		if($sql){
	    	echo "<script>alert('Berhasil!'); document.location='usersiswa.php?id_user=$id_user' </script>";
		}
	}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
		...
		<title>Admin | Update User Siswa</title>
</head>
...
<body class="ignielPelangi">
    ...
    <div class="container"><br>
        <b>Data User Siswa&nbsp;<i class="fa fa-chevron-right"></i>&nbsp;Update</b>
        <hr>
        <div class="main-wrapper">
            <div class="main">
                <article>
                    <form action="editusersiswa.php?id_user=<?php echo $id_user; ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-row">
