...
<body class="ignielPelangi">
	...
	<div class="container"><br>
		<b>Data Prodi&nbsp;<i class="fa fa-chevron-right"></i></b>
		<hr>
		<div class="main-wrapper">
			<div class="main">
				<article>
					<table class="table table-secondary table-hover table-striped tableProdi">
						...
						<tbody>
							<?php
							$sql = mysqli_query($mysqli, "SELECT * FROM prodi  ORDER BY id_prodi DESC");
						...
						?>
							<tr>
								...
								<td>
									<a href="editprodi.php?id_prodi=<?php echo $data['id_prodi'] ?>"
										class="btn btn-warning">Update</a>
									<a href="deleteprodi.php?id_prodi=<?php echo $data['id_prodi'] ?>"
				...
				<aside>
					<a href="tambahprodi.php" class="btn btn-dark">Tambah<br> Data Prodi</a>
