...
if(isset($_POST['submit'])){
	...
	$kelas = $_POST['kelas'];
	$data2 = implode(',',$kelas);
	$cek = mysqli_query($mysqli, "SELECT * FROM guru WHERE nip = '$nip'") or die(mysqli_error($mysqli));
	if(mysqli_num_rows($cek) == 0){
	$sql = mysqli_query($mysqli, "INSERT INTO guru(id_guru,nip, nama_guru, alamat, mapel, kelas,gelar) VALUES('','$nip', '$nama_guru', '$alamat','$data','$data2','$gelar')") or die(mysqli_error($mysqli));
	
	echo var_dump($sql);
		if($sql){
			echo '<script>alert("Berhasil menambahkan data."); document.location="dataguru.php";</script>';
			
		}else{
			echo json_encode($sql);
				}
	}else{
		 echo '<script>alert("Gagal, NIP sudah terdaftar");
		 	document.location="tambahguru.php";</script>';
		}
	}
?>
<!DOCTYPE html>
...
<body class="ignielPelangi">
	...
	<div class="container"><br>
		<b>Data Guru&nbsp;<i class="fa fa-chevron-right"></i>&nbsp;Insert</b>
		<hr>
					...
					<form action="tambahguru.php" method="POST">
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>NIP</label>
								<input type="text" name="nip" class="form-control" id="nipguru" placeholder="NIP Guru">
							</div>
							<div class="form-group col-md-6">
								<label>Nama</label>
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<div class="form-check">
									<input class="form-check-input" type="checkbox" name="mapel[] mapel"
							...
							<div class="form-group col-md-6">
								...
								<div class="form-check form-check-inline">
									...
									<label
										class="form-check-label"><?php echo $d['tingkat_kelas']?>&nbsp;<?php echo $d['kode_prodi']?>&nbsp;<?php echo $d['kode_kelas']?></label>
								</div>
								<?php
									}
								?>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<table class="table table-striped table-hover table-secondary tableGuru">
...
<script>
	$(document).ready(function () {
		...
		$(".tableGuru tbody tr").click(function () {
