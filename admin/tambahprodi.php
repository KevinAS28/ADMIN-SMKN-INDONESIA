...
if(isset($_POST['submit'])){
	...
	$cek = mysqli_query($mysqli, "SELECT * FROM prodi WHERE id_prodi = 'prodi'");
	if(mysqli_num_rows($cek) == 0){
	$sql = mysqli_query($mysqli, "INSERT INTO prodi (id_prodi,kode_prodi, nama_prodi) VALUES('','$kode_prodi','$nama_prodi')") or die(mysqli_error($mysqli));		
		if($sql){
			echo '<script>alert("Berhasil menambahkan data."); document.location="dataprodi.php";</script>';
		}else{
			echo json_encode($sql);
				}
	}else{
		 echo '<script>alert("Gagal, PRODI sudah terdaftar");
		 	document.location="tambahprodi.php";</script>';
		}
	}
?>
<!DOCTYPE html>
...
<head>
	<meta charset="utf-8">
		...
		<title>Admin | Insert Prodi</title>
</head>
...
<body class="ignielPelangi">
	...
	<div class="container"><br>
		<b>Data Prodi&nbsp;<i class="fa fa-chevron-right"></i>&nbsp;Insert</b>
		<hr>
