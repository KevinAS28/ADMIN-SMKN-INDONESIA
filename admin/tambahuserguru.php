...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows($cek) == 0 AND in_array($ekstensi, $ekstensi_foto) === true){
	    ...
	    $sql = mysqli_query($mysqli, "INSERT INTO user (id_user, foto, username, password, level) VALUES('','$foto','$username','$password','$level')") or die(mysqli_error($mysqli));		
		if($sql){
			echo '<script>alert("Berhasil menambahkan data."); document.location="userguru.php";</script>';
		}else{
...
<head>
	<meta charset="utf-8">
		...
		<title>Admin | Insert User Guru</title>
</head>
...
<body class="ignielPelangi">
	...
	<div class="container"><br>
		<b>Data User Guru&nbsp;<i class="fa fa-chevron-right"></i>&nbsp;Insert</b>
		<hr>
		<div class="main-wrapper">
			<div class="main">
				<article>
                    <form action="tambahuserguru.php" method="POST" enctype="multipart/form-data">
						<div class="form-row">
				...
				<aside>
					...
					<a href="userguru.php" class="btn btn-dark">Tampil<br> User Guru</a>
